...
#self
    ...
    for i in range(client_num):
        ...
        for j in range(label_num):
            ec=tensor_intersect(class_index[j], torch.IntTensor(user_data_index[i]))
            tu.append([user_data_index[i].index(j) for j in ec.numpy().tolist()])
        user_batch_index.append(tu[:])
    return user_features,adj_list,label_num,train_features,train_labels,test_features,test_labels,val_features,val_labels,at_features,at_labels,user_batch_index
