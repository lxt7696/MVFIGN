...
class HEManager:
    ...
    def __init__(self, party_id):
        ...
        self.context = None
        self.setup_context()
        print(f"[HEManager] Party {party_id} initialized")
...
class GradientAggregator:
    ...
    def aggregate_gradients(self, local_gradients):
        ...
        if not self.use_he:
            # 明文聚合
            return self._plaintext_aggregate(local_gradients), 0.0  # 添加时间返回值
