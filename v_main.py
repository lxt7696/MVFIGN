import argparse
import torch
from v_deal_iid import deal_dataset
import numpy as np
...
if __name__ == '__main__':
    ...
    for epoch4 in tqdm(range(args.round2)):
        ...
        if tt<tmp_test_acc:
            tt=tmp_test_acc
    log_file = open(r"figure5_PubMed_iid_loss.txt", encoding="utf-8",mode="a+")  
    ...
    log_file = open(r"figure5_PubMed_iid_acc.txt", encoding="utf-8",mode="a+")  
    with log_file as f:
